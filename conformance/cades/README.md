...
## Fixture obrigatória para release estável

Uma fixture publicada DEVE conter:

- `payload.jcs` — bytes RFC 8785 exactos;
...
O directório ainda não contém uma fixture B-LTA real. A especificação não deve
