...
|---|---|---|---|---|
| 01 | Informação Técnica IT/2026/00045 | `informacao-tecnica@2.0.0` | `b55c4eaa-6fb0-4024-8317-3a4a5eedccbd` | `sha256:35be71e428b7549a3b270d79bdee93d8a1cc0cac51d64afd9a9e1c4a8f8d5a17` |
| 02 | Parecer PAR/2026/00012 | `parecer@2.0.0` | `8e234253-b404-4aeb-80f0-f456e6d17e88` | `sha256:d69dfa4bb673901130fa0fb1d6a875909a4b5e2ed308c8e072ee479ea6b5a89d` |
| 03 | Despacho DESP/2026/00089 | `despacho@2.0.0` | `b82c82a4-d1ac-490a-8103-a47580ee651c` | `sha256:04ad1bc57f884634b918f230c5a461fa336b7837bf4b451555ba59c7aaf26274` |

**Atualizado em 2026-09-06** (NDT ROADMAP T4): `corpo`/`texto` dos três tipos
passou de string simples a NCRTF — ver
`specs/registry/schemas/{informacao-tecnica,parecer,despacho}.schema.json`
v2.0.0. Os `payload_hash` acima foram recalculados após a alteração; os
valores anteriores (`@1.0.0`) deixaram de ser válidos.
